...
class TestAddPackageWithWarnUnpinnedInYaml:
    ...
    contained warn-unpinned: false and dvt deps --add-package was run. The code
    ...
    def test_add_package_with_warn_unpinned_in_yaml(self, clean_start):
        ...
        run_dbt(["deps", "--add-package", "dvt-labs/dbt_utils@1.0.0"])
        ...
        assert "dvt-labs/dbt_utils" in contents or "dbt_utils" in contents
