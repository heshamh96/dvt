...
ADAPTER_INFO_SPEC = "iglu:com.dvt/adapter_info/jsonschema/1-0-1"
DEPRECATION_WARN_SPEC = "iglu:com.dvt/deprecation_warn/jsonschema/1-0-0"
BEHAVIOR_CHANGE_WARN_SPEC = "iglu:com.dvt/behavior_change_warn/jsonschema/1-0-0"
EXPERIMENTAL_PARSER = "iglu:com.dvt/experimental_parser/jsonschema/1-0-0"
INVOCATION_ENV_SPEC = "iglu:com.dvt/invocation_env/jsonschema/1-0-0"
INVOCATION_SPEC = "iglu:com.dvt/invocation/jsonschema/1-0-2"
LOAD_ALL_TIMING_SPEC = "iglu:com.dvt/load_all_timing/jsonschema/1-0-3"
PACKAGE_INSTALL_SPEC = "iglu:com.dvt/package_install/jsonschema/1-0-0"
PARTIAL_PARSER = "iglu:com.dvt/partial_parser/jsonschema/1-0-1"
PLATFORM_SPEC = "iglu:com.dvt/platform/jsonschema/1-0-0"
PROJECT_ID_SPEC = "iglu:com.dvt/project_id/jsonschema/1-0-1"
RESOURCE_COUNTS = "iglu:com.dvt/resource_counts/jsonschema/1-0-1"
RPC_REQUEST_SPEC = "iglu:com.dvt/rpc_request/jsonschema/1-0-1"
RUNNABLE_TIMING = "iglu:com.dvt/runnable/jsonschema/1-0-0"
RUN_MODEL_SPEC = "iglu:com.dvt/run_model/jsonschema/1-1-0"
PLUGIN_GET_NODES = "iglu:com.dvt/plugin_get_nodes/jsonschema/1-0-0"
ARTIFACT_UPLOAD = "iglu:com.dvt/artifact_upload/jsonschema/1-0-0"
...
def track_invocation_start(invocation_context):
    ...
    track(active_user, category="dvt", action="invocation", label="start", context=context)
...
def track_model_run(options):
    ...
    track(
        active_user, category="dvt", action="run_model", label=get_invocation_id(), context=context
    )
...
def track_invocation_end(invocation_context, result_type=None):
    ...
    track(active_user, category="dvt", action="invocation", label="end", context=context)
...
def track_invalid_invocation(args=None, result_type=None):
    ...
    track(active_user, category="dvt", action="invocation", label="invalid", context=context)
