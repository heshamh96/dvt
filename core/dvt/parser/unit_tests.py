...
from dvt.context.providers import generate_parser_unit_test_context, get_rendered
...
class UnitTestParser(YamlReader):
    ...
    def _promote_first_non_none_row(self, ut_fixture):
        ...
        See https://github.com/dvt-labs/dvt-redshift/issues/821 for more info.
        """
...
def process_models_for_unit_test(
    ...
    target_model_is_incremental = "macro.dvt.is_incremental" in target_model.depends_on.macros
