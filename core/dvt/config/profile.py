...
from dvt.adapters.contracts.connection import Credentials, HasCredentials
...
dvt encountered an error while trying to read your profiles.yml file.
...
class Profile(HasCredentials):
    ...
    def pick_profile_name(
        ...
        # TODO: Duplicating this method as direct copy of the implementation in dvt.cli.resolvers
        # dvt.cli.resolvers implementation can't be used because it causes a circular dependency.
