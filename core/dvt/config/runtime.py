...
from dvt.adapters.contracts.connection import (
    AdapterRequiredConfig,
    Credentials,
    HasCredentials,
)
from dvt.adapters.contracts.relation import ComponentName
from dvt.adapters.factory import get_include_paths, get_relation_class_by_name
...
class RuntimeConfig(Project, Profile, AdapterRequiredConfig):
    ...
    def from_parts(
        ...
        :param profile: A parsed dvt Profile.
        :param project: A parsed dvt Project.
